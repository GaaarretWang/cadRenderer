...
private:
    ...
    void load_materials(const std::vector<tinyobj::material_t>& objmaterials,vsg::ref_ptr<vsg::PbrMaterialArray>& mat_val, std::vector<std::vector<std::string>>& textures);
public:
