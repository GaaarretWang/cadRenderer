...
int NvDecoder::setReconfigParams(const Rect1 *pCropRect, const Dim *pResizeDim)
{
...
NvDecoder::NvDecoder(CUcontext cuContext, bool bUseDeviceFrame, cudaVideoCodec eCodec, bool bLowLatency, 
    bool bDeviceFramePitched, const Rect1 *pCropRect, const Dim *pResizeDim, bool extract_user_SEI_Message,
