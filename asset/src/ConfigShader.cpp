...
vsg::ref_ptr<vsg::ShaderSet> ConfigShader::buildShadowShader(std::string vert, std::string frag)
{
    ...
    shaderSet->addDescriptorBinding("GlobalBuffer", "", MATERIAL_DESCRIPTOR_SET, 12, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1, VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT, vsg::ubyteArray::create(sizeof(GlobalConstantData)));
...
vsg::ref_ptr<vsg::ShaderSet> ConfigShader::buildLineShader(std::string vert, std::string frag)
{
    ...
    shaderSet->addDescriptorBinding("GlobalBuffer", "", MATERIAL_DESCRIPTOR_SET, 12, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1, VK_SHADER_STAGE_FRAGMENT_BIT, vsg::ubyteArray::create(sizeof(GlobalConstantData)));
